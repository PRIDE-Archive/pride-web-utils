...
/**
 * {@code RestError} represents an exception which can directly be parsed as error output of a
 * RESTful API
 *
 * <p>Please note, you should try to use {@code RestError.Builder} to create an instance of {@code
 * RestError}
 *
 * @author Rui Wang
 * @version $Id$
...
public class RestError {
  ...
  public boolean equals(Object o) {
    ...
    if (developerMessage != null
        ? !developerMessage.equals(restError.developerMessage)
        : restError.developerMessage != null) return false;
    if (message != null ? !message.equals(restError.message) : restError.message != null)
      return false;
    if (moreInfoUrl != null
        ? !moreInfoUrl.equals(restError.moreInfoUrl)
        : restError.moreInfoUrl != null) return false;
    if (status != restError.status) return false;
    if (throwable != null ? !throwable.equals(restError.throwable) : restError.throwable != null)
      return false;
