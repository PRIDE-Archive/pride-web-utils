...
/**
 * Have a look here: http://www.oracle.com/technetwork/java/filters-137243.html at the section
...
public class FrontierTemplateFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    caw.write(
        frontierTemplate.substring(
            frontierTemplate.indexOf("##contentHTML##") + 15, frontierTemplate.length()));
